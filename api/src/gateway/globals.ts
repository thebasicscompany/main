...
// Internal header prefix for control-plane headers between the bridge
// middleware and gateway handlers. Modified from upstream to match this
// repo's naming policy.
export const POWERED_BY: string = 'basics-gw';
...
export const METRICS_KEYS = {
  ...
  GATEWAY_MIDDLEWARE_PRE_REQUEST_START: 'gatewayMiddlewarePreRequestStart',
  GATEWAY_MIDDLEWARE_PRE_REQUEST_END: 'gatewayMiddlewarePreRequestEnd',
  GATEWAY_MIDDLEWARE_POST_REQUEST_START: 'gatewayMiddlewarePostRequestStart',
  GATEWAY_MIDDLEWARE_POST_REQUEST_END: 'gatewayMiddlewarePostRequestEnd',

...
// google-vertex-ai dropped from this build; the vertex-llama branch below
// is now an unreachable string compare against `'__dropped_vertex_llama__'`.
const VertexLlamaChatCompleteStreamChunkTransform = {
  name: '__dropped_vertex_llama__',
} as { name: string };
import { OpenAIChatCompleteResponse } from '../providers/openai/chatComplete.js';
import { OpenAICompleteResponse } from '../providers/openai/complete.js';
import { endpointStrings } from '../providers/types.js';
import { Params } from '../types/requestBody.js';
import { getStreamModeSplitPattern, type SplitPatternType } from '../utils.js';

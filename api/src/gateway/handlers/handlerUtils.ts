...
import { endpointStrings } from '../providers/types.js';
import { Options, Params, StrategyModes, Targets } from '../types/requestBody.js';
import { convertKeysToCamelCase } from '../utils.js';
import { retryRequest } from './retryHandler.js';
import { env } from 'hono/adapter';
import { afterRequestHookHandler, responseHandler } from './responseHandlers.js';
import { HookSpan } from '../middlewares/hooks/index.js';
import { ConditionalRouter } from '../services/conditionalRouter.js';
import { RouterError } from '../errors/RouterError.js';
import { GatewayError } from '../errors/GatewayError.js';
import { HookType } from '../middlewares/hooks/types.js';

// Services
import { CacheResponseObject, CacheService } from './services/cacheService.js';
import { HooksService } from './services/hooksService.js';
import { LogObjectBuilder, LogsService } from './services/logsService.js';
import { PreRequestValidatorService } from './services/preRequestValidatorService.js';
import { ProviderContext } from './services/providerContext.js';
    ...
    case StrategyModes.FALLBACK:
      for (const [index, target] of currentTarget.targets.entries()) {
        ...
        const gatewayException =
          response?.headers.get('x-basics-gw-gateway-exception') === 'true';
        if (
        ...
        response = new Response(
          ...
          }),
          {
            ...
            headers: {
              ...
              'x-basics-gw-gateway-exception': 'true',
            },
          }
        );
      }

...
import { MAX_RETRY_LIMIT_MS, POSSIBLE_RETRY_STATUS_HEADERS } from '../globals.js';
...
export const retryRequest = async (
  ...
  try {
    await retry(
      // Upstream patches async-retry to pass a third `rateLimiter` arg via
      // patches/. We don't run patch-package; cast to bypass the 2-arg type.
